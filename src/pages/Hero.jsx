...
const Hero = () => {
  ...
  const handleMemoriesDrive = () => {
    window.open("https://drive.google.com/drive/folders/1JituMemories", "_blank");
  };
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-10">
          ...
          <line x1="15%" y1="20%" x2="85%" y2="30%" stroke="#7c3aed" strokeWidth="0.5" strokeDasharray="4 4" />
          <line x1="25%" y1="80%" x2="75%" y2="70%" stroke="#7c3aed" strokeWidth="0.5" strokeDasharray="4 4" />
        </svg>
      </div>
      ...
      <div className="absolute top-[15%] right-[15%] hidden lg:block">
        <div className="flex gap-3 animate-float-slow">
          <span className="px-3 py-1 bg-purple-500/10 border border-purple-500/20 rounded-full text-purple-400 text-xs font-mono">Node.js</span>
        </div>
      </div>
      <div className="absolute bottom-[20%] left-[12%] hidden lg:block">
        <div className="flex gap-3 animate-float-delayed">
          <span className="px-3 py-1 bg-purple-500/10 border border-purple-500/20 rounded-full text-purple-400 text-xs font-mono">MongoDB</span>
        </div>
      </div>
      <div className="absolute top-[40%] left-[5%] hidden lg:block">
        <div className="flex gap-3 animate-float">
          <span className="px-3 py-1 bg-purple-500/10 border border-purple-500/20 rounded-full text-purple-400 text-xs font-mono">Docker</span>
        </div>
      </div>
      <div className="absolute bottom-[30%] right-[10%] hidden lg:block">
        <div className="flex gap-3 animate-float-slow">
          <span className="px-3 py-1 bg-purple-500/10 border border-purple-500/20 rounded-full text-purple-400 text-xs font-mono">REST API</span>
        </div>
      </div>
          ...
          >
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white">
                Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600 animate-pulse-glow">Jitu</span>
              </h1>
              ...
              <p className="text-gray-400 text-lg max-w-xl leading-relaxed">
                I build scalable backend systems, RESTful APIs, and cloud-ready applications 
            ...
            <div className="flex flex-wrap gap-4">
              <button 
                className="group relative px-8 py-3 bg-gradient-to-r from-purple-600 to-purple-500 rounded-lg text-white font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-600/50"
              >
              ...
              <button 
                className="px-8 py-3 border border-purple-600 rounded-lg text-purple-400 font-medium transition-all duration-300 hover:bg-purple-600/10 hover:border-purple-500 hover:text-purple-300"
              >
                Contact Me
              </button>
